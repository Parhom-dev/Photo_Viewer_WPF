...
namespace PhotoViewer
{
    partial class Model
    {
        ...
        private static Int32Rect Zoom(Size imgSize, Size controlSize, double zoomModificator, ref Vector frameOffset)
        {
            ...
            {
                if (frameX + frameOffset.X + frameWidth > controlSize.Width)
                {
            ...
            {
                if (frameY + frameOffset.Y + frameHeight > controlSize.Height)
                {
